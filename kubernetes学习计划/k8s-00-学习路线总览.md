...
| 模块 | Day | 文章标题 |
|------|-----|----------|
| **M1** 集群架构与搭建 | Day 01 | [集群架构原理与环境准备](M1-集群架构与搭建/k8s-day01-集群架构原理与环境准备.md) |
| | Day 02 | [多节点集群与节点管理](M1-集群架构与搭建/k8s-day02-多节点集群与节点管理.md) |
| | Day 03 | [集群运维与 kubectl 精通](M1-集群架构与搭建/k8s-day03-集群运维与kubectl精通.md) |
| **M2** Pod 与核心工作负载 | Day 04 | [Pod 生命周期与多容器模式](M2-Pod与核心工作负载/k8s-day04-Pod生命周期与多容器模式.md) |
| | Day 05 | [Deployment 与 ReplicaSet](M2-Pod与核心工作负载/k8s-day05-Deployment与ReplicaSet.md) |
| | Day 06 | [DaemonSet、StatefulSet、Job、CronJob](M2-Pod与核心工作负载/k8s-day06-DaemonSet-StatefulSet-Job-CronJob.md) |
| | Day 07 | [Pod 资源综合实战](M2-Pod与核心工作负载/k8s-day07-Pod资源综合实战.md) |
| **M3** 网络与服务发现 | Day 08 | [Service 与集群内服务发现](M3-网络与服务发现/k8s-day08-Service与集群内服务发现.md) |
| | Day 09 | [Ingress 与外部流量接入](M3-网络与服务发现/k8s-day09-Ingress与外部流量接入.md) |
| | Day 10 | [网络策略与 CNI 原理](M3-网络与服务发现/k8s-day10-网络策略与CNI原理.md) |
| | Day 11 | [网络综合实战](M3-网络与服务发现/k8s-day11-网络综合实战.md) |
| **M4** 存储与配置管理 | Day 12 | [ConfigMap 与 Secret](M4-存储与配置管理/k8s-day12-ConfigMap与Secret.md) |
| | Day 13 | [Volume 与 PV/PVC](M4-存储与配置管理/k8s-day13-Volume与PV-PVC.md) |
| | Day 14 | [StorageClass 与动态供给](M4-存储与配置管理/k8s-day14-StorageClass与动态供给.md) |
| | Day 15 | [存储综合实战](M4-存储与配置管理/k8s-day15-存储综合实战.md) |
| **M5** 调度与资源管理 | Day 16 | [调度策略与亲和性](M5-调度与资源管理/k8s-day16-调度策略与亲和性.md) |
| | Day 17 | [资源限制与 QoS](M5-调度与资源管理/k8s-day17-资源限制与QoS.md) |
| | Day 18 | [调度综合实战](M5-调度与资源管理/k8s-day18-调度综合实战.md) |
| **M6** 安全与认证 | Day 19 | [RBAC 权限控制](M6-安全与认证/k8s-day19-RBAC权限控制.md) |
| | Day 20 | [ServiceAccount 与镜像安全](M6-安全与认证/k8s-day20-ServiceAccount与镜像安全.md) |
| | Day 21 | [安全综合实战](M6-安全与认证/k8s-day21-安全综合实战.md) |
| **M7** 监控日志与排错 | Day 22 | [Prometheus 监控体系](M7-监控日志与排错/k8s-day22-Prometheus监控体系.md) |
| | Day 23 | [日志收集与 EFK](M7-监控日志与排错/k8s-day23-日志收集与EFK.md) |
| | Day 24 | [故障排查实战](M7-监控日志与排错/k8s-day24-故障排查实战.md) |
| **M8** 综合实战与赛题模拟 | Day 25 | [赛题模拟 1-3](M8-综合实战与赛题模拟/k8s-day25-赛题模拟1-3.md) |
| | Day 26 | [赛题模拟 4-5](M8-综合实战与赛题模拟/k8s-day26-赛题模拟4-5.md) |
| | Day 27 | [赛题模拟 6-7](M8-综合实战与赛题模拟/k8s-day27-赛题模拟6-7.md) |
| | Day 28 | [赛题模拟 8 + 限时挑战](M8-综合实战与赛题模拟/k8s-day28-赛题模拟8+限时挑战.md) |
| | Day 29 | [弱点回顾与强化](M8-综合实战与赛题模拟/k8s-day29-弱点回顾与强化.md) |
| | Day 30 | [全真模拟考试](M8-综合实战与赛题模拟/k8s-day30-全真模拟考试.md)
