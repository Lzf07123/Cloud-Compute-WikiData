...
本命令在以下课程中讲解：[Day 2：权限深入与提权](../学习路线与课程/week2-day2-权限深入与提权.md) | [Day 5：本周串联实操](../学习路线与课程/week2-day5-本周串联实操.md)

## 🔗 相关文档

[权限与用户管理-chmod](权限与用户管理-chmod.md) | [权限与用户管理-chgrp](权限与用户管理-chgrp.md) | [权限与用户管理-umask](权限与用户管理-umask.md) | [权限与用户管理-usermod](权限与用户管理-usermod.md)
