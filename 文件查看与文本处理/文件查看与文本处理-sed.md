...
本命令在以下课程中讲解：[Day 3：sed 流编辑](../学习路线与课程/week3-day3-sed流编辑.md)

## 🔗 相关文档

[文件查看与文本处理-grep](文件查看与文本处理-grep.md) | [文件查看与文本处理-awk](文件查看与文本处理-awk.md) | [文件查看与文本处理-cut](文件查看与文本处理-cut.md) | [文件查看与文本处理-tr](文件查看与文本处理-tr.md)
