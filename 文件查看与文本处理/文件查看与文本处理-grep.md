...
本命令在以下课程中讲解：[Day 1：grep 基础](../学习路线与课程/week3-day1-grep基础.md) | [Day 2：grep 正则与上下文](../学习路线与课程/week3-day2-grep正则.md)

## 🔗 相关文档

[文件查看与文本处理-sed](文件查看与文本处理-sed.md) | [文件查看与文本处理-awk](文件查看与文本处理-awk.md) | [文件查看与文本处理-cut](文件查看与文本处理-cut.md) | [文件查看与文本处理-sort](文件查看与文本处理-sort.md)
