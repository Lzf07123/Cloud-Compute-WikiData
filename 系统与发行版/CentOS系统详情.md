...
> 参见: [四大服务器系统对比总览 — openEuler / CentOS / Ubuntu / Debian](四大服务器系统对比总览.md) | [Linux 发行版系别与差异详解](Linux发行版系别与差异详解.md) | [openEuler 详情](openEuler系统详情.md) | [Ubuntu 详情](Ubuntu系统详情.md) | [Debian 详情](Debian系统详情.md)
