...
| 命令 | 详细参考 |
|------|----------|
| `pwd` | {% post_link 文件与目录管理/文件与目录管理-pwd %} |
| `cd` | {% post_link 文件与目录管理/文件与目录管理-cd %} |
| `ls` | {% post_link 文件与目录管理/文件与目录管理-ls %} |
| `touch` | {% post_link 文件与目录管理/文件与目录管理-touch %} |
| `rm` | {% post_link 文件与目录管理/文件与目录管理-rm %} |
| `mkdir` | {% post_link 文件与目录管理/文件与目录管理-mkdir %} |
| `rmdir` | {% post_link 文件与目录管理/文件与目录管理-rmdir %} |
| `cp` | {% post_link 文件与目录管理/文件与目录管理-cp %} |
| `mv` | {% post_link 文件与目录管理/文件与目录管理-mv %} |
| `ln` | {% post_link 文件与目录管理/文件与目录管理-ln %} |
| `cat` | {% post_link 文件查看与文本处理/文件查看与文本处理-cat %} |
| `head` | {% post_link 文件查看与文本处理/文件查看与文本处理-head %} |
| `tail` | {% post_link 文件查看与文本处理/文件查看与文本处理-tail %} |
| `less` | {% post_link 文件查看与文本处理/文件查看与文本处理-less %} |
| `wc` | {% post_link 文件查看与文本处理/文件查看与文本处理-wc %} |
| `sort` | {% post_link 文件查看与文本处理/文件查看与文本处理-sort %} |
| `uniq` | {% post_link 文件查看与文本处理/文件查看与文本处理-uniq %} |
