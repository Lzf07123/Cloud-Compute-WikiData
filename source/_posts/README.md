...
- linux基础命令系列
  ...
  - 系统管理-uname
  - 网络管理-iptables
  - Shell内置与杂项-true-false-sleep
  - 磁盘与存储管理-fsck
  - 文件与目录管理-mv
  - 文件与目录管理-ln
  - 文件查看与文本处理-tee
  - Shell内置与杂项-command-exec
  - 系统管理-lscpu
  - 进程管理-pidof
  - Shell内置与杂项-read
  - 网络管理-scp
