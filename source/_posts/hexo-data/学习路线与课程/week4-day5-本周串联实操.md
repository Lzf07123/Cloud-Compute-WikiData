...
| `df` | {% post_link 文件与目录管理/文件与目录管理-df %} |
| `du` | {% post_link 文件与目录管理/文件与目录管理-du %} |
| `free` | {% post_link 系统管理/系统管理-free %} |
| `uptime` | {% post_link 进程管理/进程管理-uptime %} |
| `uname` | {% post_link 系统管理/系统管理-uname %} |
| `who` | {% post_link 权限与用户管理/权限与用户管理-who %} |
| `crontab` | {% post_link 系统管理/系统管理-crontab %} |
