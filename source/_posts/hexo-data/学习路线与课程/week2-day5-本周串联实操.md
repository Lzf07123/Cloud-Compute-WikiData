...
| 命令 | 详细参考 |
|------|----------|
| `whoami` | {% post_link 权限与用户管理/权限与用户管理-whoami %} |
| `id` | {% post_link 权限与用户管理/权限与用户管理-id %} |
| `groups` | {% post_link 权限与用户管理/权限与用户管理-id %} |
| `chmod` | {% post_link 权限与用户管理/权限与用户管理-chmod %} |
| `chown` | {% post_link 权限与用户管理/权限与用户管理-chown %} |
| `su` | {% post_link 权限与用户管理/权限与用户管理-su %} |
| `sudo` | {% post_link 权限与用户管理/权限与用户管理-sudo %} |
| `ps` | {% post_link 进程管理/进程管理-ps %} |
| `top` | {% post_link 进程管理/进程管理-top %} |
| `kill` | {% post_link 进程管理/进程管理-kill %} |
| `pkill` | {% post_link 进程管理/进程管理-pkill %} |
