...
| **操作系统** | Ubuntu 22.04 LTS | Ubuntu 22.04 LTS | 大赛官方推荐，内核 5.15+ |
| **内核版本** | ≥ 5.4 | 5.15+ | 支持 cgroup v2、eBPF |
...
| **操作系统** | Ubuntu 22.04 LTS | Ubuntu 22.04 LTS | 与 Master 保持一致 |
| **内核版本** | ≥ 5.4 | 5.15+ | — |
...
| **关闭防火墙** | `ufw disable`（学习环境） | 简化网络配置；生产环境应开放特定端口 |
| **禁用 SELinux** | `setenforce 0`（学习环境） | 避免容器权限问题 |
...
| **Snap 卸载** | `apt remove --purge snapd` | Snap 安装的包会干扰 kubeadm 依赖 |
